...
dCards = {
     ...
     '11' : {'panels' : ['attack','megaDefend'], 'faceoffVal' :  11.0},
     '12' : {'panels' : ['attack','megaDefend'], 'faceoffVal' : 12.0},
     '13' : {'panels' : ['attack','ultraAttack'], 'faceoffVal' : 13.0},
     ...
     '20' : {'panels' : ['attack', 'ultraDefend'], 'faceoffVal' : 20.0},
     ...
     '27' : {'panels' : ['defend', 'megaAttack'], 'faceoffVal' : 0},
     '28' : {'panels' : ['defend', 'megaAttack'], 'faceoffVal' : 0},
     '29' : {'panels' : ['defend', 'megaDefend'], 'faceoffVal' : 0},
     '30' : {'panels' : ['defend', 'megaDefend'], 'faceoffVal' : 0},
     '31' : {'panels' : ['defend', 'ultraAttack'], 'faceoffVal' : 0},
     '32' : {'panels' : ['defend', 'ultraDefend'], 'faceoffVal' : 0},
     ...
     '44' : {'panels' : ['wounded', 'inACorner'], 'faceoffVal' : 0},
     '45' : {'panels' : ['attack', 'counterAttack'], 'faceoffVal' : 25.0},
     '46' : {'panels' : ['attack', 'counterAttack'], 'faceoffVal' : 26.0},
     '47' : {'panels' : ['stunned', 'inACorner'], 'faceoffVal' : 0},
     '48' : {'panels' : ['stunned', 'ultraPower'],  'faceoffVal' : 0},
     '49' : {'panels' : ['stunned', 'ultraPower'],  'faceoffVal' : 0},
     '50' : {'panels' : ['stunned'], 'faceoffVal' : 0},
     '51' : {'panels' : ['disengage','ultraPower'], 'faceoffVal' : 0},
     '52' : {'panels' : ['disengage','megaPower'], 'faceoffVal' :  0},
     '53' : {'panels' : ['disengage','megaPower'], 'faceoffVal' : 0},
     '54' : {'panels' : ['disengage','megaPower'], 'faceoffVal' :  0},
}
...
dPanels = {'defend' : {'attr':['caBlue'],
          ...
          'catchABreath2' : {'attr':['draw','unstun'],
                             ...
                             'value':0.0},
          'inACorner' : {'attr':['draw','draw','draw','you draw'],
                              'color':['blue'],
